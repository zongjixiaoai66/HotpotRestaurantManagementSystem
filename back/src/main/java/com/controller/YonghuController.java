...
//                            yonghuEntity.setYonghuName(data.get(0));                    //会员姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //会员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //会员身份证号 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "会员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","会员");
