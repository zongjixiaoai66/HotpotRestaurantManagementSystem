    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="会员姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="会员姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="会员手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="会员手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="会员手机号" prop="yonghuPhone">
                           <el-input v-model="ruleForm.yonghuPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="会员身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="会员身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="会员身份证号" prop="yonghuIdNumber">
                           <el-input v-model="ruleForm.yonghuIdNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghuPhoto" label="会员头像" prop="yonghuPhoto">
                        <file-upload
                            tip="点击上传会员头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuPhoto" label="会员头像" prop="yonghuPhoto">
